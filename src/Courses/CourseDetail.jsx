...
const coursesData = [
  ...
  },
  {
    ...
    description:
      "Conceptual clarity and problem-based learning on laws of motion with NEET orientation.",
    thumbnail:
      "https://images.examples.com/wp-content/uploads/2024/04/Newton-Laws-of-Motion.png",
    videos: [
      {
        ...
        description:
          "Start with basics of laws of motion for NEET and JEE preparation.",
      },
      {
...
export const CourseDetail = () => {
  ...
  const suggestedCourses = coursesData.filter(
    (c) =>
      c.id !== course.id &&
      (c.class === course.class || c.subject === course.subject)
  );
